    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td data-label='Aksi'>
                    <a href='update.php?id=" . $row['id_brg'] . "' class='btn btn-edit'>Edit</a>
                    <a href='delete.php?id=" . $row['id_brg'] . "' class='btn btn-delete' onclick='return confirm(\"Yakin ingin menghapus data ini?\");'>Hapus</a>
                  </td>";
            echo "</tr>";
        }
